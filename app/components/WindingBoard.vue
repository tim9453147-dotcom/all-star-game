        ...
        >
          ...
          >
            ...
            <div
              ...
              class="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-surface-900 border border-white/60 flex items-center justify-center text-[7px] sm:text-[8px] font-bold text-white shadow"
            >
